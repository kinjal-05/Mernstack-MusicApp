...
export const SongCard = ({ data, index }) => {
  ...
  const deleteObject = async (id) => {
    try {
      console.log(id);
      const res = await deleteSongById(id); // Call the corrected delete function
      ...
      setAlert("error");
      setAlertMsg("An error occurred while deleting the song.");
    } finally {
...
//     }
//     if (song !== index) {
//       dispatch({ type: actionType.SET_SONG, song: index });
//     }
//   };
